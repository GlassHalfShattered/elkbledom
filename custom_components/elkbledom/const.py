...
class EFFECTS (Enum):
    rainbow_trail = 0x01
    jump_red_green_blue_yellow_cyan_magenta_white = 0x02
    Effect3 = 0x8b
    Effect4 = 0x04
    Effect5 = 0x05
    Effect6 = 0x06
